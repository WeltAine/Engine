...
namespace Ayin {
	...
	public:
		...
		std::vector<Layer*>::iterator begin() { return m_Layers.begin(); };				//！！！不要加const，否则会返回const_iterator
		std::vector<Layer*>::iterator end() { return m_Layers.end(); };					//！！！不要加const，否则会返回const_iterator
		std::vector<Layer*>::const_iterator begin() const { return m_Layers.begin(); };
		std::vector<Layer*>::const_iterator end() const { return m_Layers.end(); };

		std::vector<Layer*>::reverse_iterator rbegin() { return m_Layers.rbegin(); };	//！！！不要加const，否则会返回const_reverse_iterator
		std::vector<Layer*>::reverse_iterator rend() { return m_Layers.rend(); };		//！！！不要加const，否则会返回const_reverse_iterator
