...
ExampleLayer::ExampleLayer()
	:Ayin::Layer("Example"),
	m_SceneCameraController{ {.Type = Ayin::Camera::CameraType::Perspective, .FOVRadians = glm::radians(60.0f), .AspectRatio = (16.0f / 9.0f), .NearPlaneDistance = 0.1f, .FarPlaneDistance = 100.0f} }
{
